...
describe('Radio', () => {
  ...
  it('Should accept a custom `className`', () => {
    ...
    const wrapper = shallow(
      <Radio {...defaultProps} className={customClassName}>
        Title
      </Radio>,
    )
  ...
  it('Should call `onChange` when selected', () => {
    ...
    const wrapper = shallow(
      <Radio {...defaultProps} onChange={onChange}>
        Title
      </Radio>,
    )
  ...
  it('Should render a subLabel', () => {
    const wrapper = shallow(
      <Radio {...defaultProps} subLabel="Sublabel1">
        Title
      </Radio>,
    )
  ...
  it('Can be displayed as highlighted', () => {
    const wrapper = shallow(
      <Radio {...defaultProps} highlighted>
        Title
      </Radio>,
    )
  ...
  it('Can be in loading state', () => {
    const wrapper = shallow(
      <Radio {...defaultProps} status={Radio.STATUS.LOADING}>
        Title
      </Radio>,
    )
  ...
  it('Can be in valid state', () => {
    const wrapper = shallow(
      <Radio {...defaultProps} status={Radio.STATUS.CHECKED}>
        Title
      </Radio>,
    )
  ...
  it('fires the callback event when valid', () => {
    const event = jest.fn()
    const wrapper = mount(
      <Radio {...defaultProps} onDoneAnimationEnd={event}>
        blabla
      </Radio>,
    )
