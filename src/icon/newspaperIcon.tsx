  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <path
          d="M23.5,1h-18C5.224,1,5,1.224,5,1.5V13H1.5C1.224,13,1,13.224,1,13.5v8C1,22.879,2.122,24,3.5,24h18
        ...
        <path
          d="M9.5,11h4c0.276,0,0.5-0.224,0.5-0.5v-4C14,6.224,13.776,6,13.5,6h-4C9.224,6,9,6.224,9,6.5v4
